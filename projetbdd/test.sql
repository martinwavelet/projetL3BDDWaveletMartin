...
INSERT INTO utilisateur(pseudo,mdp,mail) VALUES("Michel", "Michel", "Michel@hotmail.Fr"); --6
INSERT INTO utilisateur(pseudo,mdp,mail) VALUES("Paul", "Paul", "Paul@gmail.com"); -- 7
...
INSERT INTO jeux_video(nom,id_possesseur,console,prix,nbr_joueur,commentaire_jeu) VALUES('Mario Kart 64',1,'Nintendo 64',25,4,'Un excellent jeu de kart');
INSERT INTO jeux_video(nom,id_possesseur,console,prix,nbr_joueur,commentaire_jeu) VALUES('Super Smash Bros Melee',6,'GameCube',55,4,'Un jeu de baston délirant');
INSERT INTO jeux_video(nom,id_possesseur,console,prix,nbr_joueur,commentaire_jeu) VALUES('Dead or Alive',2,'Xbox',60,4,'Le plus beau jeu de baston jamais créé !');
INSERT INTO jeux_video(nom,id_possesseur,console,prix,nbr_joueur,commentaire_jeu) VALUES('GTA Vice City',4,'PS2',30,1,'Qui ne connait pas ce jeu ?');
INSERT INTO jeux_video(nom,id_possesseur,console,prix,nbr_joueur,commentaire_jeu) VALUES('Fifa 2017',3,'PS4',35,4,'Le dernier jeu de football sorti');
INSERT INTO jeux_video(nom,id_possesseur,console,prix,nbr_joueur,commentaire_jeu) VALUES('Overwatch',7,'PS4',55,1,'Le jeu a la mode de Blizzard');
INSERT INTO jeux_video(nom,id_possesseur,console,prix,nbr_joueur,commentaire_jeu) VALUES('GTA San Andres',4,'PS3',25,1,'Mon jeu préféré');
INSERT INTO jeux_video(nom,id_possesseur,console,prix,nbr_joueur,commentaire_jeu) VALUES('Destiny',4,'Xbox One',60,1,'Graphisme magnifique');
INSERT INTO jeux_video(nom,id_possesseur,console,prix,nbr_joueur,commentaire_jeu) VALUES('Halo',7,'Xbox 360',10,4,'Un fps avec des aliens');
INSERT INTO jeux_video(nom,id_possesseur,console,prix,nbr_joueur,commentaire_jeu) VALUES('Pokemon Rubis',6,'GBA',20,1,'Pikachu !');
INSERT INTO jeux_video(nom,id_possesseur,console,prix,nbr_joueur,commentaire_jeu) VALUES('Diablo 3',5,'PC',30,1,'Un des meilleurs jeu auquel jai joué!');
